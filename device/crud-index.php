...
<!-- Dashboard of CRUD for Device Details -->
          ...
          <div class="row">
              <div class="col-md-12">
                  <div class="mt-5 mb-3 clearfix">
                      <h1 class="pull-left">DEVICE DETAILS</h1>
                      <a href="create.php" class="button pull-right"><i class="fa fa-plus"></i> Add New Device</a>
                  </div>
                  ...
                  if($result = mysqli_query($link, $sql)) {
                      if(mysqli_num_rows($result) > 0) {
                          echo '<table id="qrTable" class="table table-bordered table-striped">';
                              echo "<thead>";
                                  echo "<tr>";
                                      echo "<th>#</th>";
                                      echo "<th>Device ID Number</th>";
                                      echo "<th>Status</th>";
                                      echo "<th>Location</th>";
                                      echo "<th>Date</th>";
                                      echo "<th>QR Code</th>";
